              ...
              <CardContent className="fh-card-content p-5 sm:p-7">
                ...
                <div className="relative z-10 text-white">
                  <div className="mb-5 flex flex-wrap items-center gap-2">
                    <Badge className="rounded-full bg-white text-[#03cd8c] hover:bg-white">Fund and payout operations</Badge>
                    <Badge className="rounded-full bg-slate-900/85 text-white hover:bg-slate-900">Recurring giving, receipts, segmentation, reconciliation</Badge>
                  </div>
                  <div className="grid gap-5 lg:grid-cols-[0.64fr_0.36fr]">
                    <div className="space-y-4">
                      <div className="text-sm font-semibold uppercase tracking-[0.24em] text-white/90">Manage generosity with rigor</div>
                    ...
                    <div className="rounded-xl border border-white/15 bg-white/12 p-4 backdrop-blur">
                      ...
                      <div className="rounded-xl border border-white/15 bg-white/10 p-4">
                        <div className="text-xs uppercase tracking-[0.18em] text-white/70">Fund</div>
                      ...
                      <div className="mt-4 grid gap-2 sm:grid-cols-2">
                        <Button className="rounded-2xl bg-white text-[#03cd8c] hover:bg-white">Create fund</Button>
                        <Button
                          variant="outline"
                ...
                <div className="space-y-3">
                  {funds.map((fund) => (
                    <button
                      ...
                      className={`w-full rounded-xl border p-4 text-left shadow-sm transition ${selectedFund === fund.title ? "border-[#03cd8c]/15 bg-[#ecfff8]" : "border-slate-200 bg-white hover:border-[#03cd8c]/35"}`}
                    >
                  ...
                  <div className="space-y-4">
                    <div className="space-y-3">
                      {donorSegments.map((segment) => (
                        <div key={segment.name} className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
                    ...
                    <button
                      ...
                      className={`w-full rounded-xl border p-4 text-left transition ${donorPrivacyControls ? "border-[#03cd8c]/15 bg-[#ecfff8]" : "border-slate-200 bg-white"}`}
                    >
                ...
                <CardContent className="fh-card-content p-5 sm:p-6">
                  ...
                  <div className="space-y-4">
                    <button
                      ...
                      className={`w-full rounded-xl border p-4 text-left transition ${recurringEnabled ? "border-[#03cd8c]/15 bg-[#ecfff8]" : "border-slate-200 bg-white"}`}
                    >
                      <div className="mb-2 flex items-center gap-2 text-sm font-semibold text-slate-900">
            ...
            <Card className="fh-card rounded-xl border border-slate-200 bg-slate-950 text-white shadow-sm">
              <CardContent className="fh-card-content p-5 sm:p-6">
                <SectionHeader
                  ...
                  subtitle="Define how money leaves the platform into the institutionâ€™s payout flow."
                  action="Finance"
                />
                <div className="space-y-3">
                  ...
                  <button
                    ...
                    className={`w-full rounded-xl border p-4 text-left transition ${payoutScheduling ? "border-[#03cd8c]/30 bg-[#03cd8c]/15 text-white" : "border-white/10 bg-white/5 text-white/80"}`}
                  >
              ...
              <CardContent className="fh-card-content p-5 sm:p-6">
                ...
                <div className="space-y-3">
                  <button
                    ...
                    className={`w-full rounded-xl border p-4 text-left transition ${instantPayouts ? "border-[#03cd8c]/15 bg-[#ecfff8]" : "border-slate-200 bg-white"}`}
                  >
                    <div className="mb-2 flex items-center gap-2 text-sm font-semibold text-slate-900">
                  ...
                  <button
                    ...
                    className={`w-full rounded-xl border p-4 text-left transition ${advancedReconciliation ? "border-[#03cd8c]/15 bg-[#ecfff8]" : "border-slate-200 bg-white"}`}
                  >
                    <div className="mb-2 flex items-center gap-2 text-sm font-semibold text-slate-900">
                  ...
                  <div className="space-y-3">
                    {reconciliationItems.map((item) => (
                      <div key={item.item} className="rounded-xl border border-[#f77f00]/15 bg-white p-4 shadow-sm">
