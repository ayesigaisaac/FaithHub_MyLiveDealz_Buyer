...
const basePageRegistry: BasePageRegistryItem[] = [
  ...
  { id: "u-series-library", role: "user", section: "Series & Content", label: "Series & Sermons", path: "/app/user/series", template: "T1", description: "Series and sermon browsing with filtering.", icon: BookOpen, element: FaithHubSeriesLibrary },
  ...
  { id: "u-giving", role: "user", section: "Events, Giving & Membership", label: "Charity & Giving", path: "/app/user/giving", template: "T2", description: "Charity causes, funds, recurring gifts, and receipts.", icon: HeartHandshake, element: FaithHubGiving },
