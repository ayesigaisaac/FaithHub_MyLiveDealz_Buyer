                  ...
                  <div className="space-y-4">
                    <div className="space-y-3">
                      {donorSegments.map((segment) => (
                        <div key={segment.name} className="rounded-[24px] border border-slate-200 bg-white p-4 shadow-sm">
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-3">
                    {reconciliationItems.map((item) => (
                      <div key={item.item} className="rounded-[24px] border border-[#f77f00]/15 bg-white p-4 shadow-sm">
