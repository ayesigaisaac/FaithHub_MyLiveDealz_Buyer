              ...
              <CardContent className="fh-pad-hero">
                ...
                <div className="relative z-10 text-white">
                  <div className="mb-5 flex flex-wrap items-center gap-2">
                    ...
                    <Badge className="rounded-full bg-slate-100 text-slate-700 hover:bg-slate-100">Audit logs, immutable records, exports, SIEM integration</Badge>
                  </div>
                ...
                <div className="mb-4 flex flex-wrap gap-2">
                  {["All modules", "Verification", "Live Ops", "Channels", "Moderation", "Security"].map((item) => (
                    <button
                      ...
                      className={`rounded-full border px-4 py-2 text-sm font-medium transition ${moduleFilter === item ? "border-slate-200 bg-white text-slate-900 shadow-sm" : "border-slate-200 bg-white text-slate-700 hover:border-[#03cd8c]/35 hover:bg-[#f7fffb]"}`}
                    >
                      {item}
                    </button>
                  ))}
