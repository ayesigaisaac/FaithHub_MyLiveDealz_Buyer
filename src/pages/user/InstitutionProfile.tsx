...
const serviceSchedule = [
  { day: "Sunday", time: "8:00 AM Â· Main Service", note: "Wheelchair seating and quiet area available" },
  { day: "Wednesday", time: "6:30 PM Â· Midweek Teaching", note: "Live Sessionz + in-person hybrid" },
  { day: "Friday", time: "7:30 PM Â· Youth Fellowship", note: "Youth and family participation" },
];
...
const events = [
  { title: "Youth Worship Camp", date: "12â€“15 Aug", type: "Camp", price: "FaithMart ticket" },
...
const series = [
  { title: "Walking in Wisdom", meta: "8 episodes Â· Episode 4 live tonight" },
  { title: "Mercy in Motion", meta: "6 episodes Â· Replay available" },
  { title: "Faith That Builds", meta: "New series Â· Starts next week" },
];
...
const donationFunds = [
  ...
  { title: "Childrenâ€™s Ministry", amount: "$8,700 raised", goal: "$15,000 goal", width: "58%" },
];
      ...
      <div className="mx-auto max-w-7xl px-4 py-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 xl:grid-cols-[1.08fr_0.92fr]">
          <motion.div
            ...
            className="space-y-4"
          >
            <Card className="fh-card relative overflow-visible rounded-xl border border-slate-200 bg-gradient-to-br from-[#03cd8c] via-[#21d29d] to-[#eafcf6] shadow-sm">
              <CardContent className="fh-card-content p-5 sm:p-7">
                ...
                <div className="relative z-10 text-white">
                  <div className="mb-5 flex flex-wrap items-center gap-2">
                    <Badge className="rounded-full bg-white text-[#03cd8c] hover:bg-white">Verified institution</Badge>
                  ...
                  <div className="mb-6 flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
                    <div className="max-w-3xl space-y-3">
                      <div className="flex flex-wrap items-center gap-2">
                        <h1 className="text-4xl font-semibold leading-tight sm:text-5xl">St. Maryâ€™s Cathedral</h1>
                      ...
                      <div className="flex flex-wrap items-center gap-2 text-sm text-white/90">
                        ...
                        <span className="inline-flex items-center gap-2 rounded-full bg-white/12 px-3 py-1">
                          ...
                          Sunday 8:00 AM Â· Wednesday 6:30 PM
                        </span>
                        <span className="inline-flex items-center gap-2 rounded-full bg-white/12 px-3 py-1">
                    ...
                    <div className="flex flex-wrap gap-2">
                      <Button
                        className="rounded-2xl bg-white text-[#03cd8c] hover:bg-white"
                  ...
                  <div className="flex flex-wrap gap-2 rounded-xl bg-white/12 p-2 backdrop-blur">
                    {[
              ...
              <CardContent className="fh-card-content p-5 sm:p-6">
                ...
                <div className="grid gap-4 lg:grid-cols-[0.62fr_0.38fr]">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="rounded-xl border border-slate-200 bg-[#ecfff8] p-4">
                      <div className="mb-3 flex items-center gap-2 text-sm font-semibold text-slate-900">
                        <Accessibility className="h-4 w-4 text-[#03cd8c]" />
                        Venue accessibility information
                      </div>
                      <div className="space-y-2 text-sm text-slate-600">
                        <div>â€¢ Step-free entrance and dedicated seating</div>
                        <div>â€¢ Quiet room for families and children</div>
                        <div>â€¢ Accessible washrooms and usher support</div>
                        <div>â€¢ Audio support and transcript availability for some sessions</div>
                      </div>
                    </div>
                  </div>
                </div>
                      ...
                      {events.map((item) => (
                        <div key={item.title} className="rounded-2xl border border-slate-100 bg-[#f8fafc] p-4">
                          <div className="flex items-start justify-between gap-3">
                            <div>
                              <div className="text-sm font-semibold text-slate-900">{item.title}</div>
                              <div className="text-sm text-slate-500">{item.date} Â· {item.type}</div>
          ...
          >
              ...
              <CardContent className="fh-card-content p-5 sm:p-6">
                ...
                <div className="space-y-3">
                  {channels.map((channel) => (
                    <div key={channel.name} className="rounded-xl border border-white/10 bg-white/5 p-4 backdrop-blur">
                ...
                <div className="space-y-3">
                  {donationFunds.map((item) => (
                    <div key={item.title} className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
                      ...
                      <div className="text-sm text-slate-500">{item.amount} Â· {item.goal}</div>
            ...
            <Card className="fh-card rounded-xl border border-slate-200 bg-white shadow-sm">
              <CardContent className="fh-card-content p-5 sm:p-6">
                ...
                {!memberMode ? (
                  <div className="rounded-xl border border-dashed border-slate-200 bg-[#f8fafc] p-6 text-center">
                  ...
                  <div className="rounded-xl border border-[#03cd8c]/15 bg-[#ecfff8] p-5">
                    <div className="mb-3 flex items-center gap-2 text-sm font-semibold text-slate-900">
