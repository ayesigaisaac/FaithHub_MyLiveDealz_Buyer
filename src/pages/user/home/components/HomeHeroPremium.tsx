...
export default function HomeHeroPremium({
  ...
  return (
    <div className="rounded-[28px] border border-[var(--border)] bg-[radial-gradient(circle_at_top_right,rgba(3,205,140,0.18),transparent_45%),radial-gradient(circle_at_bottom_left,rgba(247,127,0,0.12),transparent_40%)] p-4 shadow-[0_18px_45px_-30px_rgba(3,205,140,0.55)] sm:p-6">
      <div className="flex flex-col gap-4 sm:gap-6 lg:flex-row lg:items-center lg:justify-between">
        <div className="max-w-2xl">
          ...
          <h1 className="mt-3 text-2xl font-semibold text-[var(--text-primary)] sm:text-3xl lg:text-4xl">
            Welcome back, {name}
          </h1>
        ...
        <div className="w-full max-w-sm rounded-[22px] border border-[var(--border)] bg-[var(--card)] p-3 sm:p-4">
