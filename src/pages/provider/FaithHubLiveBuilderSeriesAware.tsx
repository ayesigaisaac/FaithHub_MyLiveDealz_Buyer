          ...
          >
            <Card className="fh-interactive-card fh-surface-dark rounded-[32px] text-white">
              <CardContent className="fh-pad-panel">
                <div className="mb-4">
                  <div className="hidden text-[#8ef0ca]">Session mode</div>
              ...
              <CardContent className="fh-pad-hero">
                ...
                <div className="relative z-10 text-white">
                  <div className="mb-5 flex flex-wrap items-center gap-2">
                    ...
                    <Badge className="rounded-full bg-slate-100 text-slate-700 hover:bg-slate-100">Run-of-show, roster, platforms, monetization</Badge>
                  </div>
                  <div className="grid gap-5 lg:grid-cols-[0.64fr_0.36fr]">
                    <div className="space-y-4">
                      <div className="fh-kicker text-white/90">Live builder overview</div>
