...
const prayerRouteByRole: Record<RoleKey, string> = {
  user: routes.app.user.prayer,
  provider: routes.app.provider.prayer,
  admin: routes.app.admin.noticeboard,
};

const journalRouteByRole: Record<RoleKey, string> = {
  user: routes.app.user.journal,
  provider: routes.app.provider.journal,
  admin: routes.app.admin.noticeboard,
};
...
const qaRouteByRole: Record<RoleKey, string> = {
  user: routes.app.user.qa,
  provider: routes.app.provider.qa,
  admin: routes.app.admin.qa,
};
        ...
        <Routes>
          ...
          <Route element={<ProtectedRoute />}>
            <Route element={<Layout />}>
              ...
              <Route path="/community/journal" element={<Navigate to={journalRouteByRole[role]} replace />} />
